...
<body
    style="background-image: url('https://www.oxfordinternationaleducationgroup.com/wp-content/uploads/2022/06/Banner-4.png'); background-size: cover;background-position: center;background-attachment: fixed;">
            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="{{ route('admin.home') }}">
                    <img src="https://cdn.haitrieu.com/wp-content/uploads/2022/12/Icon-Truong-Dai-hoc-Greenwich-Viet-Nam.png"
                        alt="logo" style="width: auto; height: 80px" />
                </a>
                        ...
                        <form class="form-inline my-2 my-lg-0">
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" placeholder="Search projects"
                                    aria-label="Search projects" aria-describedby="basic-addon1">
                            </div>
                        </form>
                    </div>
                </nav>
                        ...
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#"
                            ...
                            <div class="nav-profile-img">
                                ...
                                <img src="https://img.freepik.com/premium-vector/young-smiling-man-avatar-man-with-brown-beard-mustache-hair-wearing-yellow-sweater-sweatshirt-3d-vector-people-character-illustration-cartoon-minimal-style_365941-860.jpg"
                                    alt="avatar img" style="width: 50px; height: 50px">
                            </div>
