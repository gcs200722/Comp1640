...
<div class="card bg-primary text-white">
    ...
    <div class="card-body">
        <a href="{{ route('student.submit') }}" class="btn btn-success mb-3" style="margin-left:25%">Create Contribution</a>
            ...
            <table style="width: 50%;">
                ...
                <tr>
                    ...
                    <td style="color: black; width: 200px; height: 100px;">
                        ...
                        <img src="{{ asset('storage/' . $contribution->image_path) }}" alt="Contribution Image" style="max-width: 100px;" class="zoomable-image">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="post" action="{{ route('user.destroy', $user->id) }}" class="d-inline">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-danger" style="font-weight: bold; font-size: 20px;color:red">DELETE</button>
                        </form>
                    </td>
                </tr>
            </table>
